  ...
  return(
    <Container id="Home" className="col-lg-12">
        <Row className="col-lg-12">
          <Card
            className="col-lg-6 col-md-6 col-sm-6 home bgc-whitesmoke border-secondary "style={{borderRadius:'10px', background:'#e5e5e5'}}
          >
            <Card.Body
          ...
          <Card className="col-lg-3 col-md-6 col-sm-3 border-0 mt-3" style={{background:'#e5e5e5'}}>
